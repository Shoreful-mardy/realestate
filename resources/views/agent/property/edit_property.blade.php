            ...
            <div class="mb-3">
                <div class="form-check form-check-inline">
                      <input  type="checkbox" name="featured" value="1" class="form-check-input" id="checkInline1" {{ $property->featured == '1' ? 'checked' : ' '}}>
                            <label class="form-check-label" for="checkInline1">Features Property
                        </label>
                </div>
                <div class="form-check form-check-inline">
                      <input type="checkbox" name="hot" value="1" class="form-check-input" id="checkInline2" {{ $property->hot == '1' ? 'checked' : ' '}}>
                            <label class="form-check-label" for="checkInline2">Hot Property
                        </label>
                </div>
            </div>
...
<!-- Property Main thambnail  Image Update start -->
<div class="page-content" style="margin-top:-35px;">
    <div class="row profile-body">
        ...
        <form method="post" action="{{ route('agent.update.property.thamnail') }}" id="myForm" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="id" value="{{ $property->id}}">
            ...
            <div class="row mb-3">
                <div class="form-group col-md-6">
                    <label class="form-label">Thambnail</label>
                ...
                <div class="form-group col-md-6">
                    ...
                    <img src="{{ asset($property->property_thambnail)}}" style="width:200px; height: 200px; margin-top: 7%; margin-left: 16%;">
...
<!-- Property Main thambnail  Image Update End -->
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$key+1}}</td>
                                <td class="py-1">
                                    <img src="{{ asset($img->photo_name)}}" style="width:50px;height: 50px;">
                                </td>
                                <td>
    ...
    $(document).ready(function (){
        $('#myForm').validate({
            ...
            messages :{
                ...
                lowest_price: {
                    required : 'Please Lowest Price',
                }, 
                max_price: {
                    required : 'Please Max Price',
                }, 
                property_thambnail: {
