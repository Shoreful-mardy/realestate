        ...
        <div class="row profile-body">
          ...
          <div class="col-md-8 col-xl-8 middle-wrapper">
			...
			<form class="forms-sample" method="POST" action="{{ route('agent.profile.store')}}" enctype="multipart/form-data">
				...
				<div class="mb-3">
					<label for="exampleInputEmail1" class="form-label">Compay Name</label>
				...
				<div class="mb-3">
					<img id="showImage" class="wd-80" src="{{ (!empty($profileData->photo)) ? url('upload/agent_images/'.$profileData->photo) : url('upload/no_image.jpg')}}" alt="profile">
				</div>
