...
@endphp
 ...
 <form action="{{ route('user.profile.store')}}" method="POST" class="default-form" enctype="multipart/form-data">
    @csrf
        ...
        <div class="form-group">
             <img id="showImage" class="wd-80" src="{{ (!empty($userData->photo)) ? url('upload/user_images/'.$userData->photo) : url('upload/no_image.jpg')}}" alt="profile" style="width:100px; height:100px;">
        </div>
