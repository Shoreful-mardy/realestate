@php
        $id = Auth::user()->id;
        $srequest = App\Models\Schedule::where('user_id', $id)->get();
@endphp
...
<div class="widget-content">
    ...
    <li><a href="{{ route('user.schedule.request')}}"><i class="fa fa-credit-card" aria-hidden="true"></i>Schedule Request<span class="badge badge-info">({{ count($srequest)}})</span></a></li>
