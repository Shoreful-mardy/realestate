...
<!-- Start Load Wishlist Data Script-->
...
<!-- End Load Wishlist Data Script-->
<!-- Add To Compare Start  Script-->
<script type="text/javascript">
...
<!-- Add To Compare End Script-->

<!-- Start Load Compare Data Script-->
<script type="text/javascript">
    function compare(){
        $.ajax({
            type : 'GET',
