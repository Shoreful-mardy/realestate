...
@section('main')
@section('title')
{{ $property->property_name}} | Real Estate - Property Details
@endsection
...
<!--Page Title-->
       <!--Page Title-->
        ...
        <section class="property-details property-details-one">
                    ...
                    <div class="left-column pull-left clearfix">
                        ...
                        <div class="author-info clearfix">
                            <div class="author-box pull-left">
                                ...
                                <figure class="author-thumb"><img src="{{ url('upload/profile.jpg')}}" alt=""></figure>
                                <h6>Admin</h6>
                                @else
            ...
            <ul class="list clearfix">
                @foreach($property_amenitie as $amen)
                <li>{{ $amen}}</li>
                @endforeach
            </ul>
                            </div>
                    ...
                    <div class="inner">
                        ...
                        @endforeach
                            ...
                            <div class="statistics-box content-widget">
                               ...
                               <iframe width="700" height="400" src="{{ $property->property_video}}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                            </div>
    <div class="schedule-box content-widget">
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 column">
                        <div class="form-group">
                            ...
                            <input type="text" name="tour_time" placeholder="Tour Time">
                        </div>
                    </div>
        ...
        <div class="author-box">
            ...
            <div class="inner">
                ...
                @auth
                <div id="app">
                    <send-message :recevierid="{{ $property->agent_id}}" receviername="{{ $property->user->name}}">
