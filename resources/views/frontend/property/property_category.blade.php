...
@section('main')
@section('title')
Real Estate - Categorywise Property
@endsection
<!--Page Title-->
        <section class="page-title-two bg-color-1 centred">
            ...
            <div class="auto-container">
                <div class="content-box clearfix">
                    <h1>{{$category_name->type_name}} Type Property</h1>
                    <ul class="bread-crumb clearfix">
                        <li><a href="index.html">Home</a></li>
                        <li>{{$category_name->type_name}}</li>
                    </ul>
                </div>
            </div>
        </section>
                ...
                <div class="inner-box">
                    ...
                    <div class="lower-content">
                        ...
                        <div class="other-info-box clearfix">
                            ...
                            <li><a aria-lavel="Add To Compare" class="action-btn" id="{{ $item->id }}" onclick="addToCompare(this.id)"><i class="icon-12"></i></a></li>
                            <li><a aria-lavel="Add To Wishlist" class="action-btn" id="{{ $item->id }}" onclick="addToWishList(this.id)"><i class="icon-13"></i></a></li>
                        </ul>
                        </div>
                    </div>
                </div>
