...
@section('main')
@section('title')
{{$blog['category']['category_name']}} |Real Estate - Search Results
@endsection
<!--Page Title-->
        ...
        <section class="sidebar-page-container blog-details sec-pad-2">
            <div class="auto-container">
             ...
             <div class="comments-area">
                                ...
                                <div class="comment-box">
                                    ...
                                    <div class="comment replay-comment">
                                        <figure class="thumb-box">
                                            <img src="{{ (!empty($rep->user->photo)) ? url('upload/admin_images/'.$rep->user->photo) : url('upload/no_image.jpg')}}" alt="">
                                        </figure>
                                        <div class="comment-inner">
                                            <div class="comment-info clearfix">
                                                <h5>{{ $rep->user->name}}</h5>
             ...
             @endif
                    ...
                    <p><b class="text-danger">For Add Comment You Have To Login First</b><a href="{{ route('login')}}"> Login Here</a></p>
