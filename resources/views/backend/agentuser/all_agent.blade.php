                ...
                <div class="table-responsive">
                  <table id="dataTableExample" class="table">
                    ...
                    @foreach($allagent as $key => $item)
                      <tr>
                        <td>{{$key+1}}</td>
                        <td><img src="{{ (!empty($item->photo)) ? url('upload/agent_images/'.$item->photo) : url('upload/no_image.jpg')}}" style="width:70px; height: 70px;"></td>
                        <td>{{$item->name}}</td>
                        <td>{{$item->role}}</td>
                        <td>
                        ...
                        <td>
                          <input data-id="{{ $item->id}}" class="toggle-class" type="checkbox" data-onstyle="danger"  data-offstyle="success" data-toggle="toggle" data-on="Inactive" data-off="Active" {{ $item->status ? 'checked' : ''}}>
                        </td>
