        ...
        <div class="row profile-body">
          ...
          <div class="col-md-12 col-xl-12 middle-wrapper">
			...
			<form class="forms-sample" method="POST" action="{{ route('reply.message')}}">
				...
				<div class="mb-3">
					<label for="state_name" class="form-label">User Name : </label><code>
					{{ $comment->user->name}}</code>
				</div>

				<div class="mb-3">
					<label for="exampleInputPassword1" class="form-label">Post Title : </label><code>
					{{ $comment->post->post_title}}</code>
				</div>

				<div class="mb-3">
					<label for="exampleInputPassword1" class="form-label">Subject : </label><code>
					{{$comment->subject}}</code>
				</div>

				<div class="mb-3">
					<label for="exampleInputPassword1" class="form-label">Message : </label><code>
