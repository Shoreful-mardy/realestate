...
<nav class="page-breadcrumb">
                    <ol class="breadcrumb justify-content-end">
                      ...
                      <form method="post" action="{{ route('inactive.property')}}" id="myForm">
                        @csrf
                        <input type="hidden" name="id" value="{{ $property->id}}">

                         Make It  <button type="submit" class="btn btn-danger">Inactive</button>

                     </form>

                     @else
                     <form method="post" action="{{ route('active.property')}}" id="myForm">
                        @csrf
                        <input type="hidden" name="id" value="{{ $property->id}}">
                        Make It  <button type="submit" class="btn btn-success">Active</button>
