	...
	<div class="page-content">
        ...
        <div class="row profile-body">
          ...
          <div class="col-md-12 col-xl-12 middle-wrapper">
			...
			<form id="myForm" class="forms-sample" method="POST" action="{{ route('update.post')}}" enctype="multipart/form-data">
				@csrf
        ...
        <div class="col-sm-12">
         ...
         <div class="col-sm-12">
				...
				<div class="mb-3">
					<img id="showImage" class="wd-80" src="{{ asset($post->post_image)}}" alt="profile">
				</div>
