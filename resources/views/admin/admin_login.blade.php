			...
			<div class="page-content d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-8 ps-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    <a href="#" class="noble-ui-logo logo-light d-block mb-2">Easy<span>Admin</span></a>
            ...
            <div class="mb-3">
              ...
              <input type="password" class="form-control" name="password" id="password" autocomplete="current-password" placeholder="Password">
                      ...
                      <div>
                        ...
                        <button  type="submit" href="../../dashboard.html" class="btn btn-primary me-2 mb-2 mb-md-0 text-white">Login</button>
